...
class IProviderService(Protocol):
    ...
    def analyze_video(self, url: str, temp_dir: Path, filename_prefix: str, cache_path: str, api_key: str = "", prompt_path: Optional[str] = None, audio_path: Optional[str] = None) -> VideoSummary: ...
